...
export function Logo (props) {
  const {style} = props;
  const {color = 'rgb(0, 216, 255)', height = 36} = props.style;
  ...
  return (
    <div style={style}>
      <svg style={{height}} viewBox="0 0 600 600">
        <circle cx="299.529" cy="299.628" fill={color} r="50.167"/>
        <g
          stroke={color}
          strokeMiterlimit="10"
          strokeWidth="24">
      ...
      <span style={{color, fontSize: '66.6%'}}>&nbsp;{'React'}</span>
    </div>
  );
}
